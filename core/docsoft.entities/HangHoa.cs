...
namespace docsoft.entities
{
    ...
    public class HangHoaDal
    {
        ...
        public static HangHoa Insert(HangHoa item)
        {
            ...
            obj[33] = new SqlParameter("HH_Colors", item.Colors);
            obj[34] = new SqlParameter("HH_Sizes", item.Sizes);
        ...
        public static HangHoa getFromReader(IDataReader rd)
        {
            ...
            if (rd.FieldExists("HH_Colors"))
            {
                Item.Colors = (String)(rd["HH_Colors"]);
            }
            if (rd.FieldExists("HH_Sizes"))
            {
                Item.Sizes = (String)(rd["HH_Sizes"]);
            }
            return Item;
        }
        #endregion
