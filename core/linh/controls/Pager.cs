            ...
            if (Total > 0 && Total > PageSize)
            {
                if (TotalPages < PagingSize)// Tổng số trang nhỏ hơn số trang trong khay paging
                {
                    ...
                    for (int i = Convert.ToInt32(((currentPageStage - 1) * PagingSize) + 1); i <= (currentPageStage * PagingSize); i++)
                    {
                        if (i <= TotalPages)
                        {
                            sb.AppendFormat("<li><a class=\"PagingItem {1}\" href=\"{2}\">{0}</a></li>"
                                , i==PageIndex ? string.Format("<strong>{0}</strong>",i) : i.ToString()
                ...
                else
                {
                    ...
                    {
                        #region Firts, Prev
                        sb.AppendFormat("<li class=\"pFirst\"><a class=\"PagingItem PagingItemFirts\" href=\"{0}\">&laquo;</a></li>"
                            , string.Format(CUrl, "1", Query));
                        sb.AppendFormat("<li class=\"pPrev\"><a class=\"PagingItem PagingItemPrev\" href=\"{0}\">&lsaquo;</a></li>"
                        ...
                        #endregion
                        #region Next, Last
                        sb.AppendFormat("<li class=\"pNext\"><a class=\"PagingItem PagingItemFirts\" href=\"{0}\">></a></li>"
                            , string.Format(CUrl, (currentPageStage * PagingSize) + 1, Query));
                        sb.AppendFormat("<li class=\"pLast\"><a class=\"PagingItem PagingItemFirts\" href=\"{0}\">>></a></li>"
