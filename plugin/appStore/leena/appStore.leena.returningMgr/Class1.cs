...
[assembly: WebResource("appStore.leena.returningMgr.htm.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("appStore.leena.returningMgr.JScript1.js", "text/javascript", PerformSubstitution = true)]

namespace appStore.leena.returningMgr
{
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "appStore.leena.returningMgr.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region default
