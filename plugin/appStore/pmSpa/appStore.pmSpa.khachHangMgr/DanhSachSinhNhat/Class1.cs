...
[assembly: WebResource("appStore.pmSpa.khachHangMgr.DanhSachSinhNhat.htm.htm", "text/html", PerformSubstitution = true)]
[assembly: WebResource("appStore.pmSpa.khachHangMgr.DanhSachSinhNhat.JScript1.js", "text/javascript", PerformSubstitution = true)]

namespace appStore.pmSpa.khachHangMgr.DanhSachSinhNhat
{
    public class Class1 : docPlugUI
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            switch (subAct)
            {
                case "get":
                    #region get
                    var pagerGet = KhachHangDal.pagerSinhNhat("", false, "a.KH_" +  jgrsidx + " " + jgrsord, _q, Convert.ToInt32(jgRows), KhuVuc_ID,NguonGoc_ID);
                ...
                case "scpt":
                    #region Nạp js
                    sb.AppendFormat(@"{0}"
                        , cs.GetWebResourceUrl(typeof(Class1), "appStore.pmSpa.khachHangMgr.DanhSachSinhNhat.JScript1.js"));
                    break;
                    #endregion
                default:
                    #region default
                    {
                        ...
                        sb.Append(Lib.GetResource(Assembly.GetExecutingAssembly(), "DanhSachSinhNhat.mdl.htm"));
                        sb.AppendFormat(@"<script>$.getScript('{0}',function(){1});</script>"
                            , cs.GetWebResourceUrl(typeof(Class1), "appStore.pmSpa.khachHangMgr.DanhSachSinhNhat.JScript1.js")
                            , "{DanhSachSinhNhatFn.loadgrid();}");
