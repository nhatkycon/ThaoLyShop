        ...
        protected override void Render(System.Web.UI.HtmlTextWriter writer)
        {
            ...
            switch (subact)
            {
                ...
                case "changePass":
                    ...
                    {
                        var memItem = MemberDal.SelectEmailByUserName(u);
                        pwd = maHoa.EncryptString(pwd, memItem.Username);
                        if (MemberDal.UpdatePasswordByCode(memItem.Username, _code, pwd))
                        {
                            sb.Append("1");
                        }
                        else
                ...
                case "recovery":
                    ...
                    if (!string.IsNullOrEmpty(u))
                    {
                        ...
                        if (!string.IsNullOrEmpty(e))
                        {
                            ...
                            _dele.BeginInvoke(e, "Confirmation code", string.Format("Username:{0}<br/>Confirmation code: {1}", e, newPass), null, null);
                            sb.Append("1");
                        }
                        else
                        {
